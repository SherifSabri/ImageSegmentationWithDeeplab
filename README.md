...
## Usage on Colab
![quantize.png](https://raw.github.com/SherifSabri/ImageSegmentationWithDeeplab/master/quantize.png){: width="70%" height="70%"} 
![inference.png](https://raw.github.com/SherifSabri/ImageSegmentationWithDeeplab/master/inference.png){: width="70%" height="70%"}
